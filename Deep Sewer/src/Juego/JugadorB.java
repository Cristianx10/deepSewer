...
public class JugadorB extends Personaje {
	...
	public JugadorB(Logica log, PVector pos) {
		super(log, pos);

		contSalto = 0;
		id = "UsuarioA";

		personaje[0] = new Animacion(log, pos, "Personaje2/1");
		personaje[1] = new Animacion(log, pos, "Personaje2/2");
		personaje[2] = new Animacion(log, pos, "Personaje2/3");
		personaje[3] = new Animacion(log, pos, "Personaje2/4");
